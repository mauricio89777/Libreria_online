//revisar el estilo por si acaso
  ...
  return (
    <div className="container px-4 py-8 md:px-6 md:py-12">
      ...
      <div className="max-w-3xl mx-auto prose prose-slate">
        <p className="lead">
          Bienvenido a Librería Online. Estos términos y condiciones describen
        ...
        <ul>
          ...
          <li>
            Usar este sitio web de cualquier manera que pueda ser perjudicial
            para este sitio web
          </li>
          <li>
        ...
        <p>
          ...
          responsables de ninguna pérdida en la que puedas incurrir como
        ...
        <p>
          ...
          estado original y sin usar. Los gastos de envío para devoluciones
